...
Route::any('abilityAddok','IndexController@abilityAddok');
//属性值列表
Route::any('abilityShow','IndexController@abilityShow');
//属性值修改
Route::any('abilityUpd','IndexController@abilityUpd');
Route::any('abilityUpdok','IndexController@abilityUpdok');
//商品添加
Route::any('productAdd','IndexController@productAdd');
Route::any('productAddok','IndexController@productAddok');
//商品修改
Route::any('productUpd','IndexController@productUpd');
//商品删除
Route::any('productDel','IndexController@productDel');
//商品列表
Route::any('productShow','IndexController@productShow');
Route::any('proSku','IndexController@proSku');
