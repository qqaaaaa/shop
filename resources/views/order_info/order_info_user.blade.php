...
<tbody id="content">
 ...
 <tr>
   ...
   <td><?php echo $val->consignee_name?></td>
   <td id="<?php echo $val->order_id?>"><span id="trade_status"><?php if($val->trade_status == 1){echo "已收货";}if($val->trade_status == 0){echo "配送中";}if($val->trade_status == 2){echo "未出货";}if($val->trade_status == 3){echo "已送达";}if($val->trade_status == 4){echo "其他";}?></span>
