...
<script src="../../xgreen/js/verificationNumbers.js"></script>
<script src="../../xgreen/js/Particleground.js"></script>
<script>
...
<dl class="admin_login">
 ...
 <dd class="val_icon">
  <div class="checkcode">
    <input type="text" id="J_codetext" placeholder="验证码" maxlength="4" class="login_txtbx" name="yz">
