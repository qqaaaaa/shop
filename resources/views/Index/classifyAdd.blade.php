     ...
     <div class="container" style="width:600px;">
	  ...
	  <form>
	    <div class="form-group" style="margin-top:50px;">
	      ...
	      <input type="text" class="form-control" id="clname"  placeholder="输入分类名称"><span id="in1"></span>
	    </div>
	    <div class="form-group" style="margin-top:50px;">
	      <label for="text" style="float:left;">分类排序:</label>
	      <input type="text" class="form-control" id="clorder" placeholder="输入分类排序"><span id="in2"></span>
	    </div>
      ...
      <div style="margin-top:90px;">
	    ...
	    <div style="margin-top:100px;">
	    	<button type="button" id="add" class="btn btn-primary" style="background-color:#06c1ae;border-color:#06c1ae">分类添加</button>
	    </div>
	  </form>
	</div>
</center>
